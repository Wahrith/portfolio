    ...
    <div className="navigation" style={{ top: visible ? "0" : "-70px" }}>
      ...
      <div className="menu-wrap">
        ...
        <nav id="mySidenav" className="sidenav">
          ...
          <ul id="menu">
            ...
            <li>
              <a className="link" href="https://drive.google.com/file/d/1-QWYrM3M7ta1x9BGKV-15FoR7078Qu40/view?usp=sharing" onClick={closeNav}>
                Resume
              </a>
            </li>
          </ul>
      ...
      <nav className="desktop-navigation">
        <ul>
          ...
          <li>
              <a className="link" href="https://drive.google.com/file/d/1-QWYrM3M7ta1x9BGKV-15FoR7078Qu40/view?usp=sharing">
                Resume
              </a>
            </li>
        </ul>
